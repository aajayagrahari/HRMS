...
{
   public class ExperienceMasterManager
    {

       const string ExperienceMasterTable = "ExperienceMaster";
        ErrorHandlerClass objErrorHandlerClass = new ErrorHandlerClass();
        public ICollection<ErrorHandlerClass> SaveExperienceMasterTable(ExperienceMaster argExperienceMaster)
        {
            ...
            try
            {
                ...
                InsertargExperienceMaster(argExperienceMaster, da, lstErr);
        ...
        public void InsertargExperienceMaster(ExperienceMaster argExperienceMaster, DataAccess da, List<ErrorHandlerClass> lstErr)
        {
            da.Open_Connection();

            SqlParameter[] param = new SqlParameter[9];
            param[0] = new SqlParameter("@Organization", argExperienceMaster.Organization);
            param[1] = new SqlParameter("@Designation", argExperienceMaster.Designation);
            param[2] = new SqlParameter("@Duration", argExperienceMaster.Duration);
            param[3] = new SqlParameter("@Salary", argExperienceMaster.Salary);
            param[4] = new SqlParameter("@JobDescription", argExperienceMaster.JobDescription);
            param[5] = new SqlParameter("@RRId", argExperienceMaster.RRId);
            ...
            int i = da.NExecuteNonQuery("Proc_InsertExperienceMaster", param);
