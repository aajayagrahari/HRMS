...
{
   public class EducationMasterManager
    {

       const string EducationMasterTable = "EducationMaster";
        ErrorHandlerClass objErrorHandlerClass = new ErrorHandlerClass();
        public ICollection<ErrorHandlerClass> SaveRequitmentEducationMaster(EducationMaster argEducationMaster)
        {
        ...
        public void InsertEducationMasterManager(EducationMaster argEducationMaster, DataAccess da, List<ErrorHandlerClass> lstErr)
        {
            da.Open_Connection();
