...
{
    [Serializable]
    public class TaxCalculationMaster4Deduction
    {
        private string _EmployeeId;
        private int _TDSNo;
        private int _ItemNo;
        private string _TaxableDeduction;
        ...
        public string TaxableDeduction
        {
            get
            {
                return _TaxableDeduction;
            }
            set
            {
                _TaxableDeduction = value;
            }
        }
        ...
        public void SetObjectInfo(DataRow dr)
        {
            ...
            this.TaxableDeduction = Convert.ToString(dr["TaxableDeduction"]).Trim();
