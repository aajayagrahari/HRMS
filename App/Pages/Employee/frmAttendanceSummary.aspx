<%@ Page Title="Attendance Summary" Language="C#" MasterPageFile="~/Master/EmployeeMaster.master" AutoEventWireup="true" CodeFile="frmAttendanceSummary.aspx.cs" Inherits="Pages_Employee_frmAttendanceSummary" %>
    ...
    <table id="Table1" border="0" style="height: 600px;" runat="server" cellpadding="0"
                ...
                <tr>
                    <td align="left" style="width: 100%">
                        <table id="Table11" border="0" cellpadding="0" cellspacing="0" width="100%" runat="server">
                            <tr>
                                <td align="left" style="width: 100%">
                                                            ...
                                                            <td align="left" style="width: 100%" runat="server">
                                                                <div style="width: 100%; height: 840px; overflow: auto;">
                                                                    <asp:GridView ID="grdMonthlyAttendanceSummary" runat="server" AutoGenerateColumns="False"
                                                                        DataKeyNames="AttendanceDate" Width="100%" onrowdatabound="grdMonthlyAttendanceSummary_RowDataBound"
                                                                        >
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Date">
                                                                                <ItemTemplate>
                                                                                    <asp:CheckBox ID="chk_Date" runat="server" CssClass="Label" AutoPostBack="true"
                                                                                        Text='<%#Eval("AttendanceDate")%>' />
                                                                                        <asp:HiddenField ID="hdnStaus2" runat="server" Value='<%#Eval("Status2")%>' />
                                                                                        <asp:HiddenField ID="hdnStaus3" runat="server" Value='<%#Eval("Status3")%>' />
                                                                                        <asp:HiddenField ID="hdnisApprove" runat="server" Value='<%#Eval("IsApprove")%>' />
                                                                                </ItemTemplate>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="MarkIn Time">
                                                                                <ItemTemplate>
                                                                                    <asp:TextBox ID="txt_MarkInTime" runat="server" CssClass="NumericTextBoxdesign" Enabled="false" Text='<%#Eval("MarkInTime")%>'
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Updated MarkIn Time">
                                                                                <ItemTemplate>
                                                                                    <asp:TextBox ID="txt_UpdatedMarkInTime" runat="server" CssClass="NumericTextBoxdesign" Text='<%#Eval("UpdatedMarkinTime")%>'
                                                                                        Width="60%"></asp:TextBox>
                                                                                </ItemTemplate>
                                                                                <HeaderStyle HorizontalAlign="Center" Width="40px" />
                                                                                <ItemStyle HorizontalAlign="Center" Width="40px" />
                                                                            ...
                                                                            <asp:TemplateField HeaderText="MarkOut Time">
                                                                                <ItemTemplate>
                                                                                    <asp:TextBox ID="txt_MarkOutTime" runat="server" CssClass="NumericTextBoxdesign" Text='<%#Eval("MarkOutTime")%>' Enabled="false"
                                                                                        Width="60%"></asp:TextBox>
                                                                                </ItemTemplate>
                                                                                <HeaderStyle HorizontalAlign="Center" Width="40px" />
                                                                                <ItemStyle HorizontalAlign="Center" Width="40px" />
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Updated MarkOut Time">
                                                                                <ItemTemplate>
                                                                                    <asp:TextBox ID="txt_UpdatedMarkOutTime" runat="server" CssClass="NumericTextBoxdesign" Text='<%#Eval("UpdatedMarkoutTime")%>'
                                                                                        Width="60%"></asp:TextBox>
                                                                                </ItemTemplate>
                                                                                <HeaderStyle HorizontalAlign="Center" Width="40px" />
                                                                                <ItemStyle HorizontalAlign="Center" Width="40px" />
