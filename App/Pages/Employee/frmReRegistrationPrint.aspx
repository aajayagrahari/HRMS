<%@ Page Title="" Language="C#" MasterPageFile="~/Master/EmployeeMaster.master" AutoEventWireup="true"
    CodeFile="frmReRegistrationPrint.aspx.cs" Inherits="Pages_Employee_frmReRegistrationPrint" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    <script type="text/javascript">
        ...
        function Clickthistoprint() {
            var disp_setting = "toolbar=yes,location=no,directories=yes,menubar=yes,";
            disp_setting += "scrollbars=yes,width=650, height=600, left=100, top=25";
            var content_vlue = document.getElementById("printDivReport").innerHTML;

            var docprint = window.open("", "", disp_setting);
            docprint.document.open();
            docprint.document.write('<html><head><title>Application Form</title>');
            docprint.document.write('</head><body onLoad="self.print()"><center>');
            docprint.document.write(content_vlue);
            docprint.document.write('</center></body></html>');
            docprint.document.close();
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <table width="100%">
    <tr><td><asp:Label ID="lblMsg" runat="server" Width="100%"></asp:Label></td></tr>
        <tr>
            <td align="left" valign="top">
            <asp:Button ID="btnPrint" runat="server" Text="Print Registration Form" OnClientClick="Clickthistoprint();" Visible="false" />
                <hr />
            </td>
        </tr>
        <tr>
                ...
                <table>
                    <tr>
                        ...
                        <td align="left" valign="top" colspan="2">
                            <b>
                                <asp:Label ID="lbl_msg" runat="server" Text="" ForeColor="Red"></asp:Label></b>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" valign="top">
                        ...
                        <td align="left" valign="top">
                            <asp:TextBox ID="txt_registration" runat="server" onkeypress=" return ValidateNumberOnly();"></asp:TextBox>
                        </td>
                        <td align="left" valign="top">
            ...
            <td align="center" valign="top">
                <div id="printDiv">
                    <table style="font-size: 12px; color: Black; width: 700px;">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" valign="top">
                                            <table style="font-size: 12px; color: Black;">
                                                <tr>
                                                    <td align="center" valign="top">
                                                        <b>BROADCAST ENGINEERING CONSULTANTS INDIA LTD </b>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" valign="top">
                                                        <b>(A Govt. of India Enterprise)</b>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" valign="top">
                                                        <b>Head Office:</b> 14-B, Ring Road, I.P. Estate, New Delhi-110002
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" valign="top">
                                                        <b>Tel :</b> + 91(11) 23378823-25, <b>Fax No.</b> + 91(11) 23379885
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" valign="top">
                                                        <b>Corporate Office:</b> C-56/A 17, Secto-62, Noida-201307
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" valign="top">
                                                        <b>Tel:</b> 0120-4177850, <b>Fax :</b> 0120-4177879
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" valign="top">
                                                        <b>E-Mail:</b> jobs@becil.com ,&nbsp; Website: www.becil.com
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                        ...
                        <tr>
                            <td align="left" valign="top" colspan="2">
                                <b>(Imp: Please read the details on prescribed educational, professional as well as
                                    experience requirements for the various
                                    <br />
                                    professionals before filling in the form, incomplete application will summarily
                                    be rejected) </b>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align="left" valign="top" colspan="2">
                                <asp:GridView ID="gv_references" runat="server" AutoGenerateColumns="false" Width="64%"
                                    EmptyDataText="N/A">
                                    <Columns>
                                        <asp:TemplateField ItemStyle-Width="40" HeaderText=" SL No." ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                        ...
                        <tr>
                            <td align="left" valign="top" colspan="2">
                                <asp:GridView ID="gv_Language" runat="server" AutoGenerateColumns="false" Width="50%"
                                    EmptyDataText="N/A">
                                    <Columns>
                                        <asp:TemplateField ItemStyle-Width="40" HeaderText="SL No." ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                        ...
                        <tr>
                            <td align="left" valign="top">
                                <b>How did you learn about the vacancy. </b>
                            </td>
                            <td align="left" valign="top">
                        ...
                        <tr>
                            <td align="left" valign="top">
                                <b>Note: Please provide self attested photocopies of following documents </b>
                            </td>
                            <td align="left" valign="top">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td align="left" valign="top">
                                <b>Date</b>
                                <asp:Label ID="lbl_Date" runat="server" Text="___________________________"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" valign="top" colspan="2">
    ...
    <div><table width="100%"><tr><td id="printDivReport"><asp:Literal ID="litReport" runat="server"></asp:Literal></td></tr></table></div>
</asp:Content>
