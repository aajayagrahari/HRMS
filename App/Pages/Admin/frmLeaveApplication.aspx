<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Admin.master" AutoEventWireup="true"
    CodeFile="frmLeaveApplication.aspx.cs" Inherits="Pages_Admin_frmLeaveApplication" %>
        ...
        <tr>
            <td align="center" style="width: 100%">
                <table id="Table2" border="0" runat="server" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td align="left" style="width: 100%">
                            <asp:Label ID="lblPageHeader" runat="server" Text="Leave Application" CssClass="pageHeading"></asp:Label>
                        </td>
                    </tr>
                    <tr>
