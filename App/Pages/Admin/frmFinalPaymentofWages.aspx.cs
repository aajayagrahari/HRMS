...
public partial class Pages_Admin_frmFinalPaymentofWages : System.Web.UI.Page
{
    ...
    protected void ddlMonth_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                DataSet ds = _objReportMasterManager.PaymentWages(Convert.ToInt32(ddlFinYear.SelectedValue.Split('-')[0]), Convert.ToInt32(ddlMonth.SelectedValue));
                ...
                {
                    litReport.Text = "";
                    lblMsg.Text = "There is No Record Found for this Month";
    ...
    private string PaymentWages(DataSet _ds)
    {
        ...
        DataTable _dt4 = _ds.Tables[4];
        DataTable _dt5 = _ds.Tables[5];
        DataTable _dt6 = _ds.Tables[6];
        ...
        {
            decimal TotalFixedAllowance = 0;
            decimal TotatEarningAllowance = 0;
            decimal TotalEISandEPF = 0;
            decimal TotalChallanNetPay = 0;
            Int32 TotalDay = 0;
            Int32 PaidDay = 0;
            //decimal EPF = 0;
            ...
            for (int m = 0; m < _dt1.Rows.Count; m++)
            {
                ...
                for (int j = 0; j < dtFil1.Rows.Count; j++)
                {
                    ...
                    TotalGrosPay = TotalGrosPay + Convert.ToDecimal(dtFil1.Rows[j]["FixedAllwancesAmt"].ToString());


                    TotalEarningPay = TotalEarningPay + Convert.ToDecimal(dtFil1.Rows[j]["AllwancesAmt"].ToString());
            ...
            sb.Append("</table></td>");
            sb.Append("<td><table width='100%'>");
            if (Convert.ToInt32(_dt4.Rows[0]["WD"].ToString()) > 0)
            {
                sb.Append("<tr>");
                sb.Append("<td>WD</td>");
                sb.Append("<td>:</td>");
                sb.Append("<td>" + _dt4.Rows[0]["WD"].ToString() + "</td>");
                sb.Append("</tr>");
            }
            if (Convert.ToInt32(_dt4.Rows[0]["WO"].ToString()) > 0)
            {
                sb.Append("<tr>");
                sb.Append("<td>WO</td>");
                sb.Append("<td>:</td>");
                sb.Append("<td>" + _dt4.Rows[0]["WO"].ToString() + "</td>");
                sb.Append("</tr>");
            }
            if (Convert.ToInt32(_dt4.Rows[0]["ABD"].ToString()) > 0)
            {
                sb.Append("<tr>");
                sb.Append("<td>WP</td>");
                sb.Append("<td>:</td>");
                sb.Append("<td>" + _dt4.Rows[0]["ABD"].ToString() + "</td>");
                sb.Append("</tr>");
            }
            if (Convert.ToInt32(_dt4.Rows[0]["PD"].ToString()) > 0)
            {
                sb.Append("<tr>");
                sb.Append("<td>PD</td>");
                sb.Append("<td>:</td>");
                sb.Append("<td>" + _dt4.Rows[0]["PD"].ToString() + "</td>");
                sb.Append("</tr>");
            }
            if (Convert.ToInt32(_dt4.Rows[0]["EL"].ToString()) > 0)
            {
                sb.Append("<tr>");
                sb.Append("<td>EL</td>");
                sb.Append("<td>:</td>");
                sb.Append("<td>" + _dt4.Rows[0]["EL"].ToString() + "</td>");
                sb.Append("</tr>");
            }
            if (Convert.ToInt32(_dt4.Rows[0]["CL"].ToString()) > 0)
            {
                sb.Append("<tr>");
                sb.Append("<td>CL</td>");
                sb.Append("<td>:</td>");
                sb.Append("<td>" + _dt4.Rows[0]["CL"].ToString() + "</td>");
                sb.Append("</tr>");
            }
            if (Convert.ToInt32(_dt4.Rows[0]["SL"].ToString()) > 0)
            {
                sb.Append("<tr>");
                sb.Append("<td>SL</td>");
                sb.Append("<td>:</td>");
                sb.Append("<td>" + _dt4.Rows[0]["SL"].ToString() + "</td>");
                sb.Append("</tr>");
            }
            if (Convert.ToInt32(_dt4.Rows[0]["L1"].ToString()) > 0)
            {
                sb.Append("<tr>");
                sb.Append("<td>L1</td>");
                sb.Append("<td>:</td>");
                sb.Append("<td>" + _dt4.Rows[0]["L1"].ToString() + "</td>");
                sb.Append("</tr>");
            }
            if (Convert.ToInt32(_dt4.Rows[0]["L2"].ToString()) > 0)
            {
                sb.Append("<tr>");
                sb.Append("<td>L2</td>");
                sb.Append("<td>:</td>");
                sb.Append("<td>" + _dt4.Rows[0]["L2"].ToString() + "</td>");
                sb.Append("</tr>");

            }
            if (Convert.ToInt32(_dt4.Rows[0]["L3"].ToString()) > 0)
            {
                sb.Append("<tr>");
                sb.Append("<td>L3</td>");
                sb.Append("<td>:</td>");
                sb.Append("<td>" + _dt4.Rows[0]["L3"].ToString() + "</td>");
                sb.Append("</tr>");
            }
            if (Convert.ToInt32(_dt4.Rows[0]["Maternity"].ToString()) > 0)
            {
                sb.Append("<tr>");
                sb.Append("<td>Maternity</td>");
                sb.Append("<td>:</td>");
                sb.Append("<td>" + _dt4.Rows[0]["Maternity"].ToString() + "</td>");
                sb.Append("</tr>");
            }
            ...
            sb.Append("<td colspan='4'><table width='100%'>");
            for (int b = 0; b < _dt5.Rows.Count; b++)
            {

                sb.Append("<tr>");
                sb.Append("<td>" + _dt5.Rows[b]["AllwancesName"].ToString() + "</td>");
                sb.Append("<td>:</td>");

                sb.Append("<td>" + _dt5.Rows[b]["FixedAllowanceAmt"].ToString() + "</td>");

                sb.Append("<td>" + _dt5.Rows[b]["VariableAllowanceAmt"].ToString() + "</td>");
                sb.Append("<td>0.00</td>");
                sb.Append("</tr>");
                //if (_dt5.Rows[b]["FixedAllowanceAmt"].ToString())
                TotalFixedAllowance = TotalFixedAllowance + Convert.ToDecimal(_dt5.Rows[b]["FixedAllowanceAmt"].ToString());
                TotatEarningAllowance = TotatEarningAllowance + Convert.ToDecimal(_dt5.Rows[b]["VariableAllowanceAmt"].ToString());
            ...
            sb.Append("<td>*Total*</td>");
            sb.Append("<td>:</td>");
            sb.Append("<td>" + TotalFixedAllowance + "</td>");
            sb.Append("<td>" + TotatEarningAllowance + "</td>");
            sb.Append("<td>0.00</td>");
            sb.Append("</tr>");
            sb.Append("</table></td>");

            sb.Append("<td  colspan='2'><table width='100%'>");
            for (int c = 0; c < _dt6.Rows.Count; c++)
            {
                if (_dt6.Rows[c]["DeductionName"].ToString() != "")
                {
                    sb.Append("<tr>");
                    sb.Append("<td>" + _dt6.Rows[c]["DeductionName"].ToString() + "</td>");
                    sb.Append("<td>:</td>");
                    sb.Append("<td>" + _dt6.Rows[c]["VariableDeductionAmt"].ToString() + "</td>");
                    sb.Append("</tr>");

                    TotalEISandEPF = TotalEISandEPF + Convert.ToDecimal(_dt6.Rows[c]["VariableDeductionAmt"].ToString());



                }
            }
            TotalChallanNetPay = TotatEarningAllowance - TotalEISandEPF;
            sb.Append("<tr>");
            sb.Append("<td>*Total*</td>");
            sb.Append("<td>:</td>");
            sb.Append("<td>" + TotalEISandEPF + "</td>");
            sb.Append("</tr>");
            sb.Append("<tr>");

            sb.Append("<td>*NET PAY*</td>");
            sb.Append("<td>:</td>");
            sb.Append("<td>" + TotalChallanNetPay + "</td>");
            sb.Append("</tr>");
            sb.Append("</table></td>");
            sb.Append("<td>__________</td>");
            sb.Append("</tr>");
