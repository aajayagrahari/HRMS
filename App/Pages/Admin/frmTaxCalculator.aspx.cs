...
public partial class Pages_Admin_frmTaxCalculator : System.Web.UI.Page
{
    ...
    public double CalculateMonth(double Amount)
    {
        ...
        StrFinancialYear = "01/04/" + year[0];

        DateTime dtFiscalYear = Convert.ToDateTime(Pages_Admin_frmTaxCalculator.ToDateTime1(StrFinancialYear));
        DateTime dt1 = Convert.ToDateTime(Pages_Admin_frmTaxCalculator.ToDateTime1(txtDateOfJoining.Text));
        DateTime dt2 = Convert.ToDateTime(Pages_Admin_frmTaxCalculator.ToDateTime1("31/03/"+ year[1]));
