<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Admin.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="OutOfOfficeAttendanceList.aspx.cs" Inherits="Pages_Admin_OutOfOfficeAttendanceList" %>
                ...
                <tr>
                    <td align="center" style="width: 100%">
                        <table border="0" runat="server" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td align="left" style="width: 100%">
                                    <asp:Label ID="lblPageHeader" runat="server" Text="Out Of Office Employee List" CssClass="pageHeading"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td width="49%" align="right">
                                                ...
                                                <asp:DropDownList ID="ddlFinYear" runat="server" CssClass="TextBoxdesign" Width="20%" OnSelectedIndexChanged="ddlFinYear_SelectedIndexChanged" AutoPostBack="true">
                                                </asp:DropDownList>
                                            </td>
                                                    ...
                                                    <tr>
                                                        <td align="center" style="width: 100%;" valign="top">
                                                            <div style="width: 1074px; height: 520px; overflow: auto;">
                                                                <asp:GridView ID="grdOutOfOffice" runat="server" AutoGenerateColumns="false"
                                                                    DataKeyNames="EmployeeId" Width="1076px" OnRowCommand="grdOutOfOffice_RowCommand"
                                                                    OnRowEditing="grdOutOfOffice_RowEditing" OnRowDeleting="grdOutOfOffice_RowDeleting"
                                                                    OnRowDataBound="grdOutOfOffice_RowDataBound">
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Approve/DisApprove">
                                                                            <ItemTemplate>
                                                                                <asp:RadioButtonList ID="rblApproveDisApprove" runat="server" RepeatDirection="Horizontal"
                                                                                    CssClass="TextBoxdesign" AutoPostBack="true" OnSelectedIndexChanged="rblApproveDisApprove_OnSelectedIndexChanged">
