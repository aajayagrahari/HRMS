...
public partial class Pages_Admin_ListMonthlyAttendance : System.Web.UI.Page
{
    ...
    public void BindMonthlyAttendanceDetails(string FinYear, string Month)
    {
        try
        {
            ds4MonthlyAttendanceDetails = objEmployeeMontlyAttendanceMasterManager.GetEmployeeMontlyAttendance4Month(Month, FinYear);
        ...
        try
        {
            if (Convert.ToString(ddlFinYear.SelectedValue) != "" && Convert.ToString(ddlFinYear.SelectedValue) != "&nbsp;")
            {
                ...
                else
                {
                    ...
                    BindMonthlyAttendanceDetails(Convert.ToString(ddlFinYear.SelectedValue), "-1");
                }
            }
