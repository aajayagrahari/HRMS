<%@ Page Language="C#" MasterPageFile="~/Master/Admin.master" AutoEventWireup="true"
    CodeFile="frmFinalPaymentofWages.aspx.cs" Inherits="Pages_Admin_frmFinalPaymentofWages" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <table width="100%" align="center">
                ...
                <tr>
                    <td colspan="2" id="printDiv1" align="center">
                        <div id="printDiv" style="width: 1074px; height: 520px; overflow: auto;">
