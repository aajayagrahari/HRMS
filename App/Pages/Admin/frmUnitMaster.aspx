<%@ Page Title="Unit Master Page" Language="C#" MasterPageFile="~/Master/Admin.master"
    AutoEventWireup="true" CodeFile="frmUnitMaster.aspx.cs" Inherits="Pages_Admin_frmUnitMaster" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div align="center">
        <table width="70%" align="center" cellpadding="0" cellspacing="0" style="border: 1px solid #4b6c9e">
            <tr>
                <td colspan="3">
                    <table width="100%" cellpadding="0" cellspacing="0" style="border: 1px solid #4b6c9e;
                        ...
                        <tr>
                            <td align="left" valign="top">
                                <asp:Label ID="lblPageHeading" runat="server" Text="Unit Master" CssClass="pageHeading"></asp:Label>
                                <hr />
                            </td>
                        </tr>
                    </table>
            ...
            <tr>
                ...
                <td align="left">
                    <asp:TextBox ID="txtUnitCode" runat="server" class="TextBoxdesign" onfocus="return Select(event,this,'AD',10);"
            ...
            <tr>
                ...
                <td align="left">
                    <asp:TextBox ID="txtUnitName" runat="server" class="TextBoxdesign" onfocus="return Select(event,this,'AD',30);"
            ...
            <tr>
                <td colspan="3">
                    <asp:GridView ID="gdvUnit" runat="server" AutoGenerateColumns="false" CssClass="grid_style"
                        Width="100%" OnRowCommand="gdvUnit_RowCommand" OnRowDeleting="gdvUnit_RowDeleting"
                        OnRowEditing="gdvUnit_RowEditing" OnRowDataBound="gdvUnit_RowDataBound" AllowPaging="True"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="...">
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnEdit" runat="server" CommandArgument='<%#Eval("UnitCode") %>'
                            ...
                            <asp:TemplateField HeaderText="...">
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnDelete" runat="server" CommandArgument='<%#Eval("UnitCode") %>'
